...
function AdminBanner() {
  const handleReturn = () => {
    document.cookie = "admin_viewing_as_user=;path=/;max-age=0;samesite=lax";
...
export default function DashboardLayout({
  ...
  const isAdminViewing = user?.is_admin && typeof document !== "undefined" && document.cookie.includes("admin_viewing_as_user");

  return (
    <div className="flex h-screen overflow-hidden">
      <Sidebar userName={userName} userEmail={userEmail} />
      <div className="flex flex-1 flex-col overflow-hidden">
        {isAdminViewing && <AdminBanner />}
